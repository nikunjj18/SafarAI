...
export const UI_CATALOG: readonly string[] = [
  ...
  "Marathi",
  "Mark all read",
  "Marker status uses reported location freshness and accuracy.",
  "Measured by",
  "Medium",
  "Meeting point",
  ...
  "Tap below, then choose Allow in your browser. If access is already allowed, no new permission popup is needed.",
